...
export class DataService {
  ...
  removeProduct(id: any) {
    return this.http.delete('http://localhost:3005/products/' + id)
  }


  //add product
  addProduct(bodyData: any) {
    return this.http.post('http://localhost:3005/products', bodyData)
  }

  //edit api
  updateProduct(id: any, bodyData: any) {
    return this.http.put('http://localhost:3005/products/' + id, bodyData)
  }
}
